    ...
    <section class="bg-[#D9D9D9]">
      <div class="bg-[#88A1F6] py-2 px-4 mx-auto max-w-screen-xl lg:py-4 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center lg:mb-16 mb-8">
          ...
          <a
            href="#"
            class="mx-4 inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-[#3E3131] border border-[#3E3131] rounded-lg hover:bg-[#D9D9D9] hover:text-[#3E3131]"
          >
            Upload
          </a>
          <br />
